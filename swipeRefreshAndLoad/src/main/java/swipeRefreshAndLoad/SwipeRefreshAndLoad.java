 ...
 * </p>
 */
public class SwipeRefreshAndLoad extends ViewGroup implements NestedScrollingParent,
    ...
    private static final String LOG_TAG = SwipeRefreshAndLoad.class.getSimpleName();
    ...
    private final static int LOAD_NORMAL = 0; //正常状态
    private final static int LOAD_ERROR = 1; //加载失败
    private final static int LOAD_NO_MORE = 2; //没有更多
     ...
     * @param context
     */
    public SwipeRefreshAndLoad(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public SwipeRefreshAndLoad(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void ensureTarget() {
        ...
        if (mTarget == null) {//手势目标
            for (int i = 0; i < getChildCount(); i++) {
                ...
                if (!child.equals(mCircleView) && !child.equals(mCircleViewBottom) && !child.equals(bottomLoadView)) {
                    mTarget = child;
...
//                     (width / 2 + circleWidth / 2), childHeight/2 + circleHeight);
    ...
    /**
     * Set a callback to override {@link SwipeRefreshAndLoad#canChildScrollUp()} method. Non-null
    ...
    /**
     * Classes that wish to override {@link SwipeRefreshAndLoad#canChildScrollUp()} method
     * behavior should implement this interface.
     */
    public interface OnChildScrollUpCallback {
        /**
         * Callback that will be called when {@link SwipeRefreshAndLoad#canChildScrollUp()} method
         ...
         */
        boolean canChildScrollUp(SwipeRefreshAndLoad parent, @Nullable View child);
    }
